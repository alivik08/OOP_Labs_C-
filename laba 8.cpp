...
private:
    ...
    int age;
    std::string email;
    std::string address; // Новое поле - адрес
...
int main() {
    ...
    person.setAddress("123 Main Street, New York"); // Устанавливаем адрес
    ...
    // Устанавливаем корректные значения после ошибок
    person.setName("Jane Smith");
    person.setAge(30);
    person.setEmail("jane.smith@example.com");
    person.setAddress("456 Oak Avenue, Boston");
